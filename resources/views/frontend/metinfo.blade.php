...
<html>
    <head>
        ...
        <style>
            ...
            .position-text-description {position:absolute; top:78px; right:8px; max-width:80%; padding:8px; font-size:16px; text-align:right; color:white; }
                ...
                <div class="head-bottom">
                    <div class="foto-box">
                        ...
                        <div class="social-box">
                            ...
                            <a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=4006872668&amp;aty=0&amp;a=0&amp;curl=&amp;ty=1" rel="nofollow" target="_blank">
                                <i class="fa fa-qq"></i>
                            </a>
                ...
                <div class="window-box">
                    ...
                    <div class="window-head">
                        ...
                        <div class="head-right r1">
                            <a href="tel:400-687-2668" title="400-687-2668">
                                            ...
                                            <div class="table-box">
                                                <div class="table-cell">
                                                    <div class="banner-write ">
                                                        ...
                                                        <span class="w2">
                                                          <span class="w21">年专注 · 住宅电梯+</span>
                                                          <span class="w22">别墅电梯</span>
                                            ...
                                            <div class="banner-absolute">
                                                <div class="banner-full visible-lg-block">
                                                    <ol class="list-paddingleft-2">
                                                        <li>
                                                            <p><br/></p></li><li><p><br/></p></li><li><p><br/></p></li><li><p><br/></p>
                                                        </li>
                                                    </ol>
